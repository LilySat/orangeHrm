...
class HrAdministration:
    ...
    username_row = '//th[@data-field="username"]'
    username_row_arrow = '//th[@data-field="username"]//i'
    user_role_row = '//th[@data-field="userroles"]'
    user_role_row_arrow = '//th[@data-field="userroles"]//i'
    employee_name_row = '//th[@data-field="employeeName"]'
    employee_name_row_arrow = '//th[@data-field="employeeName"]//i'
    status_row = '//th[@data-field="status"]'
    status_row_arrow = '//th[@data-field="status"]//i'
